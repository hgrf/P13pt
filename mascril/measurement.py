...
- enable carriage return in terminal and make better progress bar
- tidy up MAScriL issues on GitHub
- exceptions should be handled instead of making MAScriL crash
