...
class Measurement(MeasurementBase):
    ...
    def measure(self, Vds, Vgs, Vg_speed, stabilise_time, init, data_dir, comment, **kwargs):
        print("===================================")
        ...
        try:
            ...
            self.sourceVg = sourceVg = K2600('GPIB::26::INSTR', channel='B',
                slope=Vg_speed, initialise=init)
            self.sourceVds = sourceVds = K2600('GPIB::26::INSTR', slope=0.005,
                initialise=init, reset=False)
